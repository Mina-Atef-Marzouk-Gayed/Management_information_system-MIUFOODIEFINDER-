<?php include('./includes/header.php'); ?>
    ...
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image: url(images/IN.jpg);" data-stellar-background-ratio="0.5">
        ...
        <div class="row">
          <div class="col-md-12 ftco-animate">
			<form action="#" class="billing-form ftco-bg-dark p-3 p-md-5">
                ...
                <a href="forgetpassword.php" class="text-muted">Forgot your password?</a>
                <div class="col-md-12">
