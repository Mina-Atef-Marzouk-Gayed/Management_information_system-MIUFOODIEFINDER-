<?php include('./includes/header.php'); ?>
    ...
    <section class="home-slider owl-carousel">
      ...
      <div class="slider-item" style="background-image: url(images/Menu.jpeg);" data-stellar-background-ratio="-1.5">
        ...
        <div class="container">
          <div class="row slider-text justify-content-center align-items-center">
            ...
            <div class="col-md-7 col-sm-12 text-center ftco-animate">
				...
				<button class="btn btn-primary py-3 px-4" onclick="window.location.href='cinnabon.php';">Cinnabon</button>
<button class="btn btn-primary py-3 px-4" onclick="window.location.href='farghaly.php';">Farghaly</button>
<button class="btn btn-primary py-3 px-4" onclick="window.location.href='shabrawi.php';">Shabrawi</button>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				...
	        				<span class="price">EGP20.00</span>
	        			</div>
	        			<div class="d-block">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				...
	        				<span class="price">EGP29.00</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			...
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				...
	        				<span class="price">EGP49.91</span>
	        			</div>
	        			<div class="d-block">
	        				<p>A small river named Duden flows by their place and supplies</p>
	        			</div>
    ...
    <section class="ftco-menu mb-5 pb-5">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            ...
            <p>See Our Best Seller Categories and Shop the Top Picks!</p>
          </div>
        </div>
	    		...
	    		<div class="col-lg-12 ftco-animate p-md-5">
		          ...
		          <div class="col-md-12 nav-link-wrap mb-5">
		            <div class="nav ftco-animate nav-pills justify-content-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
		              ...
		              <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">Food</a>
		            </div>
		          </div>
		              		...
		              		<div class="col-md-4 text-center">
		              			<div class="menu-wrap">
		              				...
		              				<div class="text">
		              					...
		              					<p class="price"><span>EGP35</span></p>
